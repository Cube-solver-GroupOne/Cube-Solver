...
# compare rgb values and return color
def getcolor(r, g, b):
...
def showlable(img, index):
    if index == 1:
        cv2.putText(cubeImg, "Show face which contain yellow cubies at center", (int(17), 30),
                    cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 255, 255))
        cv2.imshow("cube", cubeImg)
    elif index == 2:
        cv2.putText(cubeImg, "Show face which contain blue cubies at center", (int(17), 30),
                    cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0))
        cv2.imshow("cube", cubeImg)
    elif index == 3:
        cv2.putText(cubeImg, "Show face which contain red cubies at center", (int(17), 30),
                    cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0))
        cv2.imshow("cube", cubeImg)
    elif index == 4:
        cv2.putText(cubeImg, "Show face which contain green cubies at center", (int(17), 30),
                    cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0))
        cv2.imshow("cube", cubeImg)
    elif index == 5:
        cv2.putText(cubeImg, "Show face which contain orange cubies at center", (int(17), 30),
                    cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0))
        cv2.imshow("cube", cubeImg)
    elif index == 6:
        cv2.putText(cubeImg, "Show face which contain white cubies at center", (int(17), 30),
                    cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0))
        cv2.imshow("cube", cubeImg)
    else:
        pass
...
while True:
    ...
    if cv2.waitKey(1) == ord('c'):  # extracting color from cube after click 'c' on keyboard
        ...
        for i in pixel:
            ...
            result = getcolor(int(r_avg), int(g_avg), int(b_avg))
            color.append(result)
